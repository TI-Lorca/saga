...
<body>
  ...
  <section class="container py-lg-5">
    <!--User table-->
    <h1 class="slideInDown animated">Reportes de acceso</h1>
    <div class="form-style-5">
      <button type="button" data-toggle="modal" data-target="#Filter-export">Filtrar / Exportar</button>
    </div>
    <!-- Log filter -->
      ...
      <div class="modal-dialog modal-dialog-centered modal-lg animate" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h3 class="modal-title" id="exampleModalLongTitle">Filtrar los reportes Asistencias</h3>
            ...
            <div class="modal-body">
              <div class="container-fluid">
                <div class="row">
                  <div class="col-lg-6 col-sm-6">
                    <div class="panel panel-primary">
                      <div class="panel-heading">Filtrar por día:</div>
                      <div class="panel-body">
                        <label for="Start-Date"><b>Desde:</b></label>
                        <input type="date" name="date_sel_start" id="date_sel_start">
                        <label for="End -Date"><b>Hasta:</b></label>
                  ...
                  <div class="col-lg-6 col-sm-6">
                    <div class="panel panel-primary">
                      ...
                      <div class="panel-body">
                        <label for="Start-Time"><b>Desde horario:</b></label>
                        <input type="time" name="time_sel_start" id="time_sel_start">
                        <label for="End -Time"><b>Hasta:</b></label>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-4 col-sm-12">
                    <label for="Device"><b>Filtrar por area:</b></label>
