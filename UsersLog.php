...
<body>
  ...
  <section class="container py-lg-5">
    <!--User table-->
    <h1 class="slideInDown animated">Reportes de presencia</h1>
      ...
      <div class="modal-dialog modal-dialog-centered modal-lg animate" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h3 class="modal-title" id="exampleModalLongTitle">Filtrar reportes:</h3>
                ...
                <div class="row">
                  ...
                  <div class="col-lg-6 col-sm-6">
                    <div class="panel panel-primary">
                      ...
                      <div class="panel-body">
                        <label for="Start-Time"><b>Desde:</b></label>
