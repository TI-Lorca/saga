...
if (isset($_POST['dev_add'])) {
    ...
    if (empty($dev_name)) {
        echo '<p class="alert alert-danger">Por favor seleccionar el nombre del dipositivo!!</p>';
    }
    elseif (empty($dev_dep)) {
        echo '<p class="alert alert-danger">Por favor seleccionar el nombre del area donde estara el dipositivo!!</p>';
    }
    else{
