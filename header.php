...
<header>
    ...
    <a href="ManageUsers.php">Registrar</a>
    <a href="UsersLog.php">Asistencia</a>
	<a href="AccessLog.php">Acceso</a>
	...
	<div class="modal-dialog modal-dialog-centered" role="document">
		<div class="modal-content">
			<div class="modal-header">
				<h3 class="modal-title" id="exampleModalLongTitle">Actualiza tu información:</h3>
			...
			<form action="ac_update.php" method="POST" enctype="multipart/form-data">
				<div class="modal-body">
					<label for="User-mail"><b>Nombre:</b></label>
					...
					<input type="email" name="up_email" placeholder="Ingresa tu E-mail..." value="<?php echo $_SESSION['Admin-email']; ?>" required /><br>
					<label for="User-psw"><b>Password</b></label>
					<input type="password" name="up_pwd" placeholder="Ingresa tu Password..." required /><br>
				</div>
